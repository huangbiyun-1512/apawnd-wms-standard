package com.maersk.asia.wms.standard.config;
...
public class RedisConfig {
    ...
    RedisCacheConfiguration highjumpGenericsTtl2hConfiguration() {
        return RedisCacheConfiguration.defaultCacheConfig()
            .computePrefixWith(
                CacheKeyPrefix.prefixed(CacheConstant.CACHE_KEY_PREFIX_WMS_STANDARD))
    ...
    private Map<String, RedisCacheConfiguration> BuildRedisCacheConfigurationMap() {
        ...
        map.put(
            CacheConstant.CACHE_CONFIGURATION_KEY_DC_2H,
